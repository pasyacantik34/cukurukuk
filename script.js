...
(function(canvas) { // Main function
    ...
    var image = (function() { // Create particle image
        ...
        function to(t) { // Convert t to radians 
            ...
            point.x = settings.particles.size / 2 + point.x * settings.particles.size / 500; // Ubah dari 350 ke 500
            point.y = settings.particles.size / 2 - point.y * settings.particles.size / 500; // Ubah dari 350 ke 500
    ...
    function render() { // Render function
        ...
        // Hitung posisi tengah animasi hati
        const heartCenterX = canvas.width / 2;
        const heartCenterY = canvas.height / 2;
    
        // Tambahkan teks "Semangat kerjanya Akbar" di tengah hati
        context.fillStyle = "#ea80b0"; // Warna teks
        context.font = "bold 30px Arial"; // Gaya font
        context.textAlign = "center"; // Posisikan teks di tengah horizontal
        context.textBaseline = "middle"; // Posisikan teks di tengah vertikal
        context.fillText("Semangat cukurkuk", heartCenterX, heartCenterY); // Gambar teks di posisi hati
        ...
        for (var i = 0; i < amount; i++) { // Add particles
            ...
            particles.add(heartCenterX + pos.x, heartCenterY - pos.y, dir.x, -dir.y);
        }
